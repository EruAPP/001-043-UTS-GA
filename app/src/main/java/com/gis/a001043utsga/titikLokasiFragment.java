 ...
 * Use the {@link titikLokasiFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class titikLokasiFragment extends Fragment implements
    ...
    EditText latitude_text, longtitude_text, nama, nowa;
    TextView kota_lokasi;
     ...
     * @return A new instance of fragment titiLokasiFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static titikLokasiFragment newInstance(String param1, String param2) {
        titikLokasiFragment fragment = new titikLokasiFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_lokasi = (Button) a.findViewById(R.id.btn_lokasi);
        kota_lokasi = (TextView) a.findViewById(R.id.kotaLokasi);
        ...
        nowa = (EditText) a.findViewById(R.id.nowa);
        ...
        btn_lokasi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } else if (nowa.getText().toString().isEmpty()) {
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (mTrackingLocation) {
                    new taskAddress(titikLokasiFragment.this, titikLokasiFragment.this)
    ...
    private void stopTrackingLocation() {
        if (mTrackingLocation) {
            ...
            btn_lokasi.setText("DAPATKAN LOKASI");
            kota_lokasi.setText(R.string.awal);
            nama.setEnabled(true);
            nama.setText("");
            nowa.setText("");
            nowa.setEnabled(true);
